...
public class DataManager {
    ...
    public static void loadFromDatabase(NoteBookSQLiteOpenHelper dbHelper) {
    ...
    public int createNewNote() {
        NoteInfo note = new NoteInfo(mNotes.size()-1, null, null, null);
        mNotes.add(note);
    ...
    public void initializeExampleNotes() {
        ...
        mNotes.add(new NoteInfo(id+1, course, "Delegating intents",
        ...
        mNotes.add(new NoteInfo(id+1, course, "Service default threads",
                "Did you know that by default an Android Service will tie up the UI thread?"));
        mNotes.add(new NoteInfo(id+1, course, "Long running operations",
        ...
        mNotes.add(new NoteInfo(id+1, course, "Parameters",
                "Leverage variable-length parameter lists"));
        mNotes.add(new NoteInfo(id+1, course, "Anonymous classes",
        ...
        mNotes.add(new NoteInfo(id+1, course, "Compiler options",
                "The -jar option isn't compatible with with the -cp option"));
        mNotes.add(new NoteInfo(id+1, course, "Serialization",
